...
5. ~~**Zálohy Postgresu a obnova.**~~ **Index je v MongoDB, ne v Postgresu** — Tina bere jako index libovolnou implementaci `abstract-level` a hotová je pro MongoDB nebo Redis. Databáze drží index obsahu, ne obsah samotný (ten je v gitu), takže ztráta není fatální — ale je potřeba vědět, jak se index znovu postaví.
